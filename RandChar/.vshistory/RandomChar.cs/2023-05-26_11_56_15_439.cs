...
public class RandomChar
{
    ...
    public static void Fill(Span<char> chars, ASCIICategory category, params ASCIICategory[] categories)
    {
        var characters = CharSet.GetUIDs(category, categories);
    ...
    public static void Fill(Span<char> chars, UnicodeCategory category, params UnicodeCategory[] categories)
    {
        var characters = CharSet.GetUIDs(category, categories);
    ...
    public static void Fill(Span<char> chars, int startingAt, int count, ASCIICategory category, params ASCIICategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void Fill(Span<char> chars, int startingAt, int count, UnicodeCategory category, params UnicodeCategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(char[] chars, ASCIICategory category, params ASCIICategory[] categories)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(char[] chars, UnicodeCategory category, params UnicodeCategory[] categories)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(char[] chars, int startingAt, int count, ASCIICategory category, params ASCIICategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(char[] chars, int startingAt, int count, UnicodeCategory category, params UnicodeCategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(Span<char> chars, ASCIICategory category, params ASCIICategory[] categories)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(Span<char> chars, UnicodeCategory category, params UnicodeCategory[] categories)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(Span<char> chars, int startingAt, int count, ASCIICategory category, params ASCIICategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(Span<char> chars, int startingAt, int count, UnicodeCategory category, params UnicodeCategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
