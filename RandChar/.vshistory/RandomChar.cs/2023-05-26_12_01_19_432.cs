...
public class RandomChar
{
    ...
    public static string Append(string str, int count, ASCIICategory[] categories) => 
        $"{str}{GetString(count, categories)}";

    public static string Append(string str, int count, UnicodeCategory[] categories) => 
        $"{str}{GetString(count, categories)}";
    #endregion Append
    ...
    public static string AppendUnique(string str, int count, ASCIICategory[] categories) => 
        $"{str}{GetUniqueString(count, categories)}";

    public static string AppendUnique(string str, int count, UnicodeCategory[] categories) => 
        $"{str}{GetUniqueString(count, categories)}";
    ...
    public static void Fill(char[] chars, int startingAt, int count, ASCIICategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void Fill(char[] chars, int startingAt, int count, UnicodeCategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void Fill(Span<char> chars, int startingAt, int count, ASCIICategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void Fill(Span<char> chars, int startingAt, int count, UnicodeCategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(char[] chars, int startingAt, int count, ASCIICategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(char[] chars, int startingAt, int count, UnicodeCategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(Span<char> chars, int startingAt, int count, ASCIICategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(Span<char> chars, int startingAt, int count, UnicodeCategory[] categories)
    {
        if (startingAt < 0 || startingAt >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(startingAt)} in range [0, {chars.Length}].");
    ...
    public static string GetString(int count, ASCIICategory[] categories)
    {
        if (count < 0)
            throw new ArgumentOutOfRangeException(nameof(count), $"Expected non-negative {nameof(count)}.");
    ...
    public static string GetString(int count, UnicodeCategory[] categories)
    {
        if (count < 0)
            throw new ArgumentOutOfRangeException(nameof(count), $"Expected non-negative {nameof(count)}.");
    ...
    public static string Prepend(char character, int count, ASCIICategory[] categories) =>
        $"{GetString(count, categories)}{character}";

    public static string Prepend(char character, int count, UnicodeCategory[] categories) => 
        $"{GetString(count, categories)}{character}";

    public static string Prepend(string str, int count) => 
        $"{GetString(count)}{str}";

    public static string Prepend(string str, int count, ASCIICategory[] categories) => 
        $"{GetString(count, categories)}{str}";

    public static string Prepend(string str, int count, UnicodeCategory[] categories) => 
        $"{GetString(count, categories)}{str}";
    #endregion Prepend
    ...
    public static string PrependUnique(char character, int count, ASCIICategory[] categories) => 
        $"{GetUniqueString(count, categories)}{character}";

    public static string PrependUnique(char character, int count, UnicodeCategory[] categories) => 
        $"{GetUniqueString(count, categories)}{character}";

    public static string PrependUnique(string str, int count) => 
        $"{GetUniqueString(count)}{str}";

    public static string PrependUnique(string str, int count, ASCIICategory[] categories) =>
        $"{GetUniqueString(count, categories)}{str}";

    public static string PrependUnique(string str, int count, UnicodeCategory[] categories) => 
        $"{GetUniqueString(count, categories)}{str}";
