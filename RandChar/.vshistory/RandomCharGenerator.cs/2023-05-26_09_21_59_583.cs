...
public class RandomChar
{
    ...
    public static string PrependUnique(char str, int count, ASCIICategory category, params ASCIICategory[] categories) =>
        $"{GetUniqueString(count, category, categories)}{str}";

    public static string PrependUnique(char str, int count, UnicodeCategory category, params UnicodeCategory[] categories) =>
        $"{GetUniqueString(count, category, categories)}{str}";
