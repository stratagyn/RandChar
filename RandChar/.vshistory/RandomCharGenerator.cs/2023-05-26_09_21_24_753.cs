...
public class RandomChar
{
    ...
    public static string Prepend(char str, int count, ASCIICategory category, params ASCIICategory[] categories) =>
        $"{GetString(count, category, categories)}{str}";

    public static string Prepend(char str, int count, UnicodeCategory category, params UnicodeCategory[] categories) =>
        $"{GetString(count, category, categories)}{str}";
