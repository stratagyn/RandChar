...
{
    private static IDictionary<ASCIICategory, int[]> ASCIICharacters = new Dictionary<ASCIICategory, int[]>
    {
    ...
    public static readonly int[] AlphaNumeric =
    {
        ...
        0x005A, 0x0061, 0x0062, 0x0063, 0x0064,
    ...
    public static readonly int[] LowercaseLetter =
    {
        0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 
        0x0066, 0x0067, 0x0068, 0x0069, 0x006A, 
        0x006B, 0x006C, 0x006D, 0x006E, 0x006F, 
    ...
    public static readonly int[] UppercaseLetter =
    {
        0x0041, 0x0042, 0x0043, 0x0044, 0x0045,
        0x0046, 0x0047, 0x0048, 0x0049, 0x004A,
        0x004B, 0x004C, 0x004D, 0x004E, 0x004F,
