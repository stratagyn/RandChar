...
public static class RandChar
{
    ...
    {
        var characters = CharaSet.GetUIDs(characterSet);
    ...
    public static void Fill(Span<char> chars, int at, int count, CharacterSet characterSet)
    {
        if (at < 0 || at >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(at)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(char[] chars, CharacterSet characterSet)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(char[] chars, int at, int count, CharacterSet characterSet)
    {
        if (at < 0 || at >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(at)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(Span<char> chars, CharacterSet characterSet)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(Span<char> chars, int at, int count, CharacterSet characterSet)
    {
        if (at < 0 || at >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(at)} in range [0, {chars.Length}].");
    ...
    public static char GetCharacter(CharacterSet characterSet)
    {
        var characters = CharaSet.GetUIDs(characterSet);
        var index = RandomNumberGenerator.GetInt32(characters.Count);
    ...
    public static char[] GetCharacters(int count, CharacterSet characterSet)
    {
        if (count < 0)
            throw new ArgumentOutOfRangeException(nameof(count), $"Expected non-negative {nameof(count)}.");

        var unicodeCharacters = CharaSet.GetUIDs(characterSet);
        var chars = new char[count];
    ...
    public static char[] GetUniqueCharacters(int count, CharacterSet characterSet)
    {
        if (count < 0)
            throw new ArgumentOutOfRangeException(nameof(count), $"Expected non-negative {nameof(count)}.");
    ...
    public static string GetString(int length, CharacterSet characterSet)
    {
        if (length < 0)
            throw new ArgumentOutOfRangeException(nameof(length), $"Expected non-negative {nameof(length)}.");
    ...
    public static string GetUniqueString(int length, CharacterSet characterSet)
    {
        if (length < 0)
            throw new ArgumentOutOfRangeException(nameof(length), $"Expected non-negative {nameof(length)}.");
