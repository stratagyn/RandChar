...
public static class RandChar
{
    ...
    public static void Fill(char[] chars, CharacterSet characterSet)
    {
        var characters = CharSet.GetUIDs(characterSet);
    ...
    public static void Fill(char[] chars, int at, int count, CharacterSet characterSet)
    {
        if (at < 0 || at >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(at)} in range [0, {chars.Length}].");
    ...
    public static void Fill(Span<char> chars, CharacterSet characterSet)
    {
        var characters = CharSet.GetUIDs(characterSet);
    ...
    public static void Fill(Span<char> chars, int at, int count, CharacterSet categories)
    {
        if (at < 0 || at >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(at)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(char[] chars, CharacterSet categories)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(char[] chars, int at, int count, CharacterSet categories)
    {
        if (at < 0 || at >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(at)} in range [0, {chars.Length}].");
    ...
    public static void FillUnique(Span<char> chars, CharacterSet categories)
    {
        if (chars.Length == 0)
            return;
    ...
    public static void FillUnique(Span<char> chars, int at, int count, CharacterSet categories)
    {
        if (at < 0 || at >= chars.Length)
            throw new IndexOutOfRangeException($"Expected {nameof(at)} in range [0, {chars.Length}].");
    ...
    public static char GetCharacter(CharacterSet categories)
    {
        var characters = CharSet.GetUIDs(categories);
        var index = RandomNumberGenerator.GetInt32(characters.Count);
    ...
    public static char[] GetCharacters(int count, CharacterSet categories)
    {
        if (count < 0)
            throw new ArgumentOutOfRangeException(nameof(count), $"Expected non-negative {nameof(count)}.");
    ...
    public static char[] GetUniqueCharacters(int count, CharacterSet categories)
    {
        if (count < 0)
            throw new ArgumentOutOfRangeException(nameof(count), $"Expected non-negative {nameof(count)}.");
    ...
    public static string GetString(int length, CharacterSet categories)
    {
        if (length < 0)
            throw new ArgumentOutOfRangeException(nameof(length), $"Expected non-negative {nameof(length)}.");
    ...
    public static string GetUniqueString(int length, ASCIICategory[] categories)
    {
        if (length < 0)
            throw new ArgumentOutOfRangeException(nameof(length), $"Expected non-negative {nameof(length)}.");
    ...
    public static string GetUniqueString(int length, CharacterSet categories)
    {
        if (length < 0)
            throw new ArgumentOutOfRangeException(nameof(length), $"Expected non-negative {nameof(length)}.");
