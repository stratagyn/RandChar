...
public static partial class CharSet
{
    ...
    private static readonly Lazy<IDictionary<UnicodeCategory, IList<int>>> CharacterSets = new(() => BuildCharacterSets());
    ...
    private static IDictionary<UnicodeCategory, int[]> BuildCharacterSets()
    {
