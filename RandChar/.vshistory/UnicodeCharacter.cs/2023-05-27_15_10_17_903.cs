...
{
    private static readonly IDictionary<UnicodeCategory, CharacterSet> UnicodeCategories = new HashSet<UnicodeCategory>
    {
        Control, 
        Format,
        LowercaseLetter,
    ...
    private static readonly Lazy<IDictionary<UnicodeCategory, IList<int>>> CharacterSets = new(() => BuildUnicodeCharacterDictionary());
