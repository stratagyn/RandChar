...
public class RandCharTests
{
    ...
    public class FillSpanTests
    {
        ...
        public void FillSpanUniqueCountAt_Passes(int count)
        {
            ...
            Assert.Equal(span[count..].Length, charsSet.Count);
        }
        ...
        public void FillSpanUniqueCharSetCountAt_Passes(CharSet charSet, int count)
        {
            ...
            Assert.Equal(count, charsSet.Count);
    ...
    public class GetCharactersTests
    {
        ...
        [Fact]
        public void GetCharacters_Zero_ZeroCharacters()
        {
            var chars = RandChar.GetCharacters(0);
        ...
        [InlineData(CharSet.NonSpacingMark)]
        [InlineData(CharSet.UppercaseLetter)]
        public void GetCharactersCharSet_Zero_ZeroCharacters(CharSet charSet)
        {
            var chars = RandChar.GetCharacters(0, charSet);
        ...
        [Fact]
        public void GetUniqueCharacters_Zero_ZeroCharacters()
        {
            var chars = RandChar.GetUniqueCharacters(0);
        ...
        [InlineData(CharSet.NonSpacingMark)]
        [InlineData(CharSet.UppercaseLetter)]
        public void GetUniqueCharactersCharSet_Zero_ZeroCharacters(CharSet charSet)
        {
            var chars = RandChar.GetUniqueCharacters(0, charSet);
    ...
    public class GetStringTests
    {
        ...
        [Fact]
        public void GetString_Zero_ZeroCharacters()
        {
            var chars = RandChar.GetString(0);
        ...
        public void GetString_Negative_ThrowsArgumentOutOfRange()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                var chars = RandChar.GetString(-1);
            });
        }
        ...
        [InlineData(CharSet.NonSpacingMark)]
        [InlineData(CharSet.UppercaseLetter)]
        public void GetStringCharSet_Zero_ZeroCharacters(CharSet charSet)
        {
            var chars = RandChar.GetString(0, charSet);
        ...
        public void GetStringCharSet_Negative_ThrowsArgumentOutOfRange(CharSet charSet)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                var chars = RandChar.GetString(-1, charSet);
            });
        }
        ...
        [Fact]
        public void GetUniqueString_Zero_ZeroCharacters()
        {
            var chars = RandChar.GetUniqueString(0);
        ...
        public void GetUniqueString_Negative_ThrowsArgumentOutOfRange()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                var chars = RandChar.GetUniqueString(-1);
            });
        }
        ...
        [InlineData(CharSet.NonSpacingMark)]
        [InlineData(CharSet.UppercaseLetter)]
        public void GetUniqueStringCharSet_Zero_ZeroCharacters(CharSet charSet)
        {
            var chars = RandChar.GetUniqueString(0, charSet);
        ...
        public void GetUniqueStringCharSet_Negative_ThrowsArgumentOutOfRange(CharSet charSet)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                var chars = RandChar.GetUniqueString(-1, charSet);
            });
        }
    }
}