...
public class RandCharTests
{
    public class FillTests
    {
        ...
        [InlineData(50)]
        [InlineData(100)]
        public void FillCountAt_Count_ThrowsIndexOutOfRange(int size)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[size];
        ...
        [InlineData(CharSet.NonSpacingMark, 100)]
        [InlineData(CharSet.UppercaseLetter, 100)]
        public void FillCharSetCountAt_Negative_ThrowsIndexOutOfRange(CharSet charSet, int size)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[size];

                RandChar.Fill(chars, -1, size, charSet);
            });
        }
        ...
        [InlineData(CharSet.NonSpacingMark, 100)]
        [InlineData(CharSet.UppercaseLetter, 100)]
        public void FillCharSetCountAt_Count_ThrowsIndexOutOfRange(CharSet charSet, int size)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[size];
        ...
        [InlineData(50)]
        [InlineData(100)]
        public void FillUniqueCountAt_Negative_ThrowsIndexOutOfRange(int size)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[size];
        ...
        [InlineData(50)]
        [InlineData(100)]
        public void FillUniqueCountAt_Count_ThrowsIndexOutOfRange(int size)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[size];
        ...
        [InlineData(CharSet.NonSpacingMark, 100)]
        [InlineData(CharSet.UppercaseLetter, 100)]
        public void FillUniqueCharSetCountAt_Negative_ThrowsIndexOutOfRange(CharSet charSet, int size)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[size];
        ...
        [InlineData(CharSet.NonSpacingMark, 100)]
        [InlineData(CharSet.UppercaseLetter, 100)]
        public void FillUniqueCharSetCountAt_Count_ThrowsIndexOutOfRange(CharSet charSet, int size)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[size];
    ...
    public class GetStringTests
    {
        ...
        [InlineData(50)]
        [InlineData(100)]
        public void GetString_Passes(int size)
        {
            var chars = RandChar.GetString(size);
            var charsSet = new HashSet<char>(chars);
        ...
        [InlineData(CharSet.NonSpacingMark, 100)]
        [InlineData(CharSet.UppercaseLetter, 100)]
        public void GetStringCharSet_Passes(CharSet charSet, int size)
        {
            var chars = RandChar.GetString(size, charSet);
            var uids = new HashSet<int>(Characters.GetUIDs(charSet));
        ...
        [InlineData(50)]
        [InlineData(100)]
        public void GetStringUnique_Passes(int size)
        {
            var chars = RandChar.GetUniqueString(size);
            var charSet = new HashSet<char>(chars);
        ...
        [InlineData(CharSet.NonSpacingMark, 100)]
        [InlineData(CharSet.UppercaseLetter, 100)]
        public void GetUniqueStringCharSet_Passes(CharSet charSet, int size)
        {
            var chars = RandChar.GetUniqueString(size, charSet);
