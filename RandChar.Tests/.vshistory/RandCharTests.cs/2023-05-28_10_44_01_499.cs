...
public class RandCharTests
{
    public class FillTests
    {
        ...
        [InlineData(50)]
        [InlineData(100)]
        public void FillCountAt_NotEnoughRoom_ThrowsArgumentOutOfRange(int size)
        {
        ...
        [InlineData(CharSet.NonSpacingMark, 100)]
        [InlineData(CharSet.UppercaseLetter, 100)]
        public void FillUniqueCharSetCountAt_N_ThrowsIndexOutOfRange(CharSet charSet, int count)
        {
            Assert.Throws<IndexOutOfRangeException>(() =>
            {
                var chars = new char[count];
